...
If you want just a easy way to get Arduino act like e.g. controller, keyboard or mouse to computer, go to https://github.com/mcgurk/Arduino-USB-HID-RetroJoystickAdapter. 
